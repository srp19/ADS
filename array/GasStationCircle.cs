...
namespace ADS.array
{
	...
	public class GasStationCircle
	{
		...
		public virtual int startTour(int[] gasAvailable, int[] gasRequired)
		{
			int start = -1;
			int end = 0;
			int currentGas = 0;
		...
		public static void Main(string[] args)
		{
			...
			int[] gasAvailable = new int[] {4, 4, 6};
			int[] gasRequired = new int[] {5, 6, 1};
			Console.WriteLine(gsc.startTour(gasAvailable, gasRequired));
			Console.WriteLine(gsc.startTour1(gasAvailable, gasRequired));
		}
	}
