...
namespace ADS.array
{
	...
	public class IncreasingSubsequnceOfLength3WithMaxProduct
	{
		...
		public virtual int maxProduct(int[] arr)
		{
		...
		{
			int[] arr = new int[] {6, 7, 8, 1, 2, 3, 9, 10};
			IncreasingSubsequnceOfLength3WithMaxProduct iss = new IncreasingSubsequnceOfLength3WithMaxProduct();
			Console.WriteLine(iss.maxProduct(arr));
			int[] arr1 = new int[] {1, 5, 10, 8, 9};
			Console.WriteLine(iss.maxProduct(arr1));
		}
	}
