...
namespace ADS.array
{
	...
	public class KthLargestInTwoSortedArray
	{
		...
		public virtual int kthLargest1(int[] arr1, int[] arr2, int low1, int high1, int low2, int high2, int k)
		{
		...
		public virtual int kthLargest(int[] input1, int[] input2, int k)
		{
		...
		public static void Main(string[] args)
		{
			...
			int[] input1 = new int[] {1,4,7,11,17,21};
			int[] input2 = new int[] {-4,-1,3,4,6,28,35,41,56,70};
			for (int i = 0; i < input1.Length + input2.Length; i++)
			{
				Console.WriteLine(kis.kthLargest(input1, input2, i + 1));
			}
